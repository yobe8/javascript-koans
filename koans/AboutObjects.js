describe("About Objects", function () {
    ...
    var megalomaniac = {
      ...
      battleCry: function (noOfBrains) {
        return "They are " + this.henchman + " and the" +
          Array(noOfBrains + 1).join(" " + this.mastermind); //5개 빈 배열을 ' brain'을 구분자로 해서 나누니 4개의 ' brain'이 문자열로 반환.
      }
    };
  ...
  describe("'in' keyword", function () {
    ...
    it("should have the bomb", function () {
      ...
      var hasBomb = "theBomb" in megalomaniac; // in 을 사용하면 객체 안의 프로퍼티 키의 존재 여부를 Boolean 값으로 반환.
  ...
  it("should use prototype to add to all objects", function () { //prototype 짱 신기.
